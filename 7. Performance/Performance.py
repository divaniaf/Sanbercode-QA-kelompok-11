...
class test_Performance_Aufar(unittest.TestCase):
    ...
    def test_Performance_1_Menambah_Job_Performance_Indicator(self):
    ...
    def test_Performance_2_Mencari_Performance_Indicator(self):
    ...
    def test_Performance_3_Edit_Performance_Indicator(self):
    ...
    def test_Performance_4_Menghapus_Performance_Indicator(self):
